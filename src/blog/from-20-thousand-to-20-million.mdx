...
editable: false
cover:
  src: "../assets/images/blog/from-20-thousand-to-20-million/cover.webp"
  alt: "From 20 Thousand to 20 Million article cover"
---

import { Image } from "astro:assets";
import diagram from "../assets/images/blog/from-20-thousand-to-20-million/diagram.webp";
...
<figure>
  <Image
    src={diagram}
    alt="Architecture of the upgraded image recognition system"
  />
  <figcaption>
    Figure 1: Architecture of the upgraded image recognition system, where Q are
    the so-called query servers and S are the so-called storage servers.
  </figcaption>
</figure>
...
[^1]: Reveel. _Make all your media interactive so you can invite audiences to explore, learn and buy._ [https://reveel.it/](https://reveel.it/)

[^2]: L. K. Saini, V. Shirvastava. (2014). _A Survey of Digital Watermarking Techniques and its Applications._ International Journal of Computer Science Trends and Technology, vol. 2, pp. 70-73.

[^3]: P. Meerwald, A. Uhl. (2010). _Watermark Detection for Video Bookmarking Using Mobile Phone Camera._ Communications and Multimedia Security, Lecture Notes in Computer Science, vol. 6109, pp. 64-74.

[^4]: W. Zhou, H. Li, Q. Tian. (2017). _Recent Advance in Content-based Image Retrieval: A Literature Survey._ [https://arxiv.org/abs/1706.06064v2](https://arxiv.org/abs/1706.06064v2)

[^5]: E. Rublee, V. Rabaud, K. Konolige, G. Bradski. (2011). _ORB: an efficient alternative to SIFT or SURF._ Proceedings of the IEEE International Conference on Computer Vision, pp. 2564-2571.

[^6]: M. Muja, D. G. Lowe. (2009). _Fast Approximate Nearest Neighbors with Automatic Algorithm Configuration._ International Conference on Computer Vision Theory and Applications.

[^7]: M. Muja, D. G. Lowe. (2012). _Fast Matching of Binary Features._ Conference on Computer and Robot Vision.

[^8]: J. Sivic, A. Zisserman. (2003). _Video Google: a text retrieval approach to object matching in videos._ Proceedings of the Ninth IEEE International Conference on Computer Vision, vol. 2.

[^9]: H. Wu, R. Luk, K. Wong, K. Kwok. (2008). _Interpreting TF-IDF term weights as making relevance decisions._ ACM Transactions on Information Systems, vol. 26.

[^10]: S. Choi, T. Kim, W. Yu. (2009). _Performance Evaluation of RANSAC Family._ Proceedings of the British Machine Vision Conference, vol. 24, pp. 1-12.

[^11]: L. Lamport. (1998). _The Part-Time Parliament._ ACM Transactions on Computer Systems 16, vol. 2, pp. 133-169.

[^12]: D. Ongaro, J. Ousterhout. (2014). _In search of an understandable consensus algorithm._ Proceeding USENIX ATC'14, pp. 305-320.

[^13]: C. Zauner. (2010). _Implementation and Benchmarking of Perceptual Image Hash Functions._ Master's thesis, Upper Austria University of Applied Sciences.

[^14]: D. Barath, J. Matas. (2017). _Graph-Cut RANSAC._ [https://arxiv.org/abs/1706.00984](https://arxiv.org/abs/1706.00984)
